package com.pauete.Lienzo.Tests;

import com.pauete.Lienzo.*;
...
public class Test1 {
    ...
    public static void main(String[] args) {
        ...
        reader.getDatabase().debug();

//        String nombre = "tablaPrueba";
//        Column columna = new Column("columnaPrueba", DataType.VARCHAR(5), true);
//
//        Table.Builder table$builder = new Table.Builder();
//        Table tablaPrueba = table$builder
//                .setName(nombre)
//
//                .addConstraint(Constraint.primaryKey(nombre, "columnaPrueba"))
//                .addConstraint(Constraint.foreignKey(nombre, "externa", "tablaExterna", "pk_tablaExterna"))
//                .addColumn(columna)
//                .build();
//
//        tablaPrueba.debug();
